...
class Cp3dViewUtilisateur extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	{			
		...
		JToolBarHelper::title(JText::_('COM_CP3D_UTILISATEUR')." : ".($isNew ? JText::_('COM_CP3D_NEW'): JText::_('COM_CP3D_MODIF')), 'address');
