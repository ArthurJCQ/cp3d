...
class Cp3dModelEntreprise extends JModelAdmin
{
	protected $_compo = 'com_cp3d';
	protected $_context = 'entreprise';
	public $typeAlias = 'com_cp3d.entreprise';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Entreprise', $prefix = 'Cp3dTable', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe($table->raisonSociale);
		}
	}
}
