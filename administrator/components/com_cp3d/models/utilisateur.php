...
class Cp3dModelUtilisateur extends JModelAdmin
{
	protected $_compo = 'com_cp3d';
	protected $_context = 'utilisateur';
	public $typeAlias = 'com_cp3d.utilisateur';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Utilisateur', $prefix = 'Cp3dTable', $config = array()) 
	{
