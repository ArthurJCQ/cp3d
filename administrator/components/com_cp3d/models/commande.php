...
class Cp3dModelCommande extends JModelAdmin
{
	protected $_compo = 'com_cp3d';
	protected $_context = 'commande';
	public $typeAlias = 'com_cp3d.commande';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Commande', $prefix = 'Cp3dTable', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe($table->numCommande);
		}
	}
}
