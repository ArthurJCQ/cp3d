...
class Cp3dModelTypeimpression extends JModelAdmin
{
	protected $_compo = 'com_cp3d';
	protected $_context = 'typeimpression';
	public $typeAlias = 'com_cp3d.typeimpression';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'TypeImpression', $prefix = 'Cp3dTable', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe('ti'.$table->id);
		}
	}
}
