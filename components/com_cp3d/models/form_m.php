...
require_once JPATH_COMPONENT_ADMINISTRATOR.'/models/modele.php';

class Cp3dModelForm_m extends Cp3dModelModele
{
	protected $_context = 'modele';
	...
	{
		$itemId = (int) (!empty($itemId)) ? $itemId : $this->getState('modele.id');
