		...
		<form action="<?php echo JRoute::_('index.php?option=com_cp3d&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				<div class="btn-group pull-left">
					...
					<h2><?php echo JText::_('COM_CP3D_UTILISATEUR')." ".($isNew ? JText::_('COM_CP3D_ADD_PAR'): JText::_('COM_CP3D_MODIF_PAR')); ?></h2>
				</div>
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#utilisateur" data-toggle="tab"><?php echo JText::_('COM_CP3D_UTILISATEUR'); ?></a></li>
					<li><a href="#avance" data-toggle="tab"><?php echo JText::_('COM_CP3D_ADVANCED'); ?></a></li>
					<li><a href="#commentaire" data-toggle="tab"><?php echo JText::_('COM_CP3D_COMMENT'); ?></a></li>
				</ul>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td width="80%">
										<div class="controls"><?php echo $this->form->getInput('idEntreprise'); ?></div>
									</td>
								</tr>
								<tr>
									<td width="20%" class="nowrap right">
										<div class="control-label"><?php echo $this->form->getLabel('idPays'); ?></div>
									</td>
									<td width="80%">
										<div class="controls"><?php echo $this->form->getInput('idPays'); ?></div>
									</td>
								</tr>
							</tbody>
						</table>
