...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_cp3d&view=lignescommande&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<br />
	<table class="table table-striped" id="articleList" style="margin-top: 40px; width: 100%;">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_COMMANDE_NUM'), 'numCde', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
		...
		<tbody>
			<?php foreach($this->items as $i => $item) : ?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td><?php echo($item->nom_client . " " . $item->prenom_client) ?></td>
