...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_UTILISATEURS_NOM'), 'nom', $listDirn, $listOrder) ?>
				</th>
				<th class="title center">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_UTILISATEURS_PRENOM'), 'prenom', $listDirn, $listOrder) ?>
				</th>
				<!-- <th class="title">Publié</th> -->
				<th class="title center">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_UTILISATEURS_EMAIL'), 'email', $listDirn, $listOrder) ?>
				</th>
				<th class="title center">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_UTILISATEURS_ENTREPRISE'), 'entreprise', $listDirn, $listOrder) ?>
				</th>
				<th class="title center">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_UTILISATEURS_PAYS'), 'pays', $listDirn, $listOrder) ?>
				</th>
		...
		<tbody>
			<?php foreach($this->items as $i => $item) : ?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center"><?php echo $item->entreprise ?></td>
					<td class="center"><?php echo $item->pays ?></td>
