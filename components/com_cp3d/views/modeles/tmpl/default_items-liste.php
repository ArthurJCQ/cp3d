...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_MODELE_IMAGE'), 'image', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_MODELE_NOM'), 'nom', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_MODELE_THEME'), 'idTheme', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_CP3D_MODELE_DESCRIPTION'), 'description', $listDirn, $listOrder) ?>
				</th>
			</tr>
		</thead>
				...
				<tr class="row<?php echo $i % 2; ?>">
					<td>
						<a href="<?php echo $uriCompoDetail.$item->id ?>">
							<img src="../images/cp3d/modeles/<?php echo  $item->image; ?>" width="50" height="50">
						</a>
					</td>
					<td>
						<a href="<?php echo $uriCompoDetail.$item->id ?>"><?php echo $item->nom ?></a>
					</td>
					<td><?php echo $item->idTheme ?></td>
