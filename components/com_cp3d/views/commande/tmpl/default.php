...
<?php else : ?>
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-right">
			<a href="<?php echo JRoute::_('index.php?option=com_cp3d&view=commande'); ?>" class="btn" role="button">
				<span class="icon-cancel"></span></a>
		</div>	
		<div class="btn-group pull-right">
			<a href="<?php echo JRoute::_('index.php?option=com_cp3d&view=lignescommande&layout=edit&ic='.$this->item->id); ?>" class="btn" role="button"><span class="icon-edit"></span></a>
		</div>	
	</div>
	<div>
		<table class="table">
